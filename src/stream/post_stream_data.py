...
def build_influx_data(payload: Dict[str, Any]) -> Tuple[Dict[str, str], Dict[str, Any]]:
    ...
    fields = {
        ...
        "tyres_pressure_RL": _array_value(tyres_pressure, 0, 0.0),
        "tyres_pressure_RR": _array_value(tyres_pressure, 1, 0.0),
        "tyres_pressure_FL": _array_value(tyres_pressure, 2, 0.0),
        "tyres_pressure_FR": _array_value(tyres_pressure, 3, 0.0),
